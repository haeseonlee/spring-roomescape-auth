...
<body>
    <div class="container">
        ...
        <div class="list-card">
            ...
            <div id="reservationsList">
                <div class="empty-state">예약 목록을 불러오는 중...</div>
            </div>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            fetch('/login/check')
                .then(res => { if (!res.ok) window.location.href = '/login?redirect=/my-reservations'; else loadReservations(); })
                .catch(() => window.location.href = '/login?redirect=/my-reservations');
        });
        ...
        function loadReservations() {
            ...
            fetch(`/reservations/mine`)
                .then(res => { if (!res.ok) { window.location.href = '/login?redirect=/my-reservations'; return; } return res.json(); })
                .then(reservations => {
