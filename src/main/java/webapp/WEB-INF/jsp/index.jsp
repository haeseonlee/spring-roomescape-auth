...
<head>
    ...
    <style>
        * {
        ...
        .btn-login { background: #151932; color: #c5cae9; }
        .btn-login:hover { background: #1a1f3a; color: #ffffff; }
        .btn-logout { background: transparent; color: #8b93b0; }
        .btn-logout:hover { color: #f5576c; border-color: #f5576c; }
        footer {
            text-align: center;
            padding-top: 40px;
...
<body>
    <div class="container">
        <div class="auth-bar" id="authBar">
            <a href="/login" class="auth-btn btn-login" id="loginBtn">로그인</a>
        </div>
        <header>
            <h1>방탈출 예약 시스템</h1>
            ...
            .then(data => {
                ...
                if (data) {
                    bar.innerHTML = `
                        ...
                        <button class="auth-btn btn-logout" onclick="logout()">로그아웃</button>
                    `;
                }
            });
