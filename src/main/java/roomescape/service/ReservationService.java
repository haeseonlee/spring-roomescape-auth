...
public class ReservationService {
    ...
    public List<ReservationResponse> readByMemberId(Long memberId) {
        return reservationQueryingDao.findAllMemberId(memberId)
                .stream()
                .map(ReservationResponse::from)
                .toList();
    }

    public ReservationResponse create(Member member, ReservationRequest reservationReq) {
        ...
        Reservation reservation = new Reservation(member.getName(), reservationReq.date(), reservationTimeById, themeById, member.getId());
