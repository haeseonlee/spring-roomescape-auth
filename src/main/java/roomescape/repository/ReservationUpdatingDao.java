...
public class ReservationUpdatingDao {
    ...
    public Long insert(Reservation reservation) {
        String sql = "insert into reservation(name, date, time_id, theme_id, member_id, created_at) values(?, ?, ?, ?, ?, ?)";
        ...
        jdbcTemplate.update(connection -> {
            ...
            ps.setLong(5, reservation.getMemberId());
            ps.setObject(6, reservation.getCreatedAt());
            return ps;
        }, keyHolder);
